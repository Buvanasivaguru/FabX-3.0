...
#define STRING_VERSION_CONFIG_H __DATE__ "22/12/15 " __TIME__ // build date and time/
#define STRING_CONFIG_H_AUTHOR "(Buvan_Redd,FabX3_Printrboard)" // Who made the changes.*******************************************************
